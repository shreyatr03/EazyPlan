...
<html lang="en">
    <?php
        session_start();
        $title = "Allocated Resource";// This is the title of a page
    ...
    <body>
        ...
        <br><h2>Allocated Resources</h2><br>
            ...
            <?php
                ...
                $sql1 = "SELECT workerID, resourceID, quantity, staffID, AllocDate, worker.name as name1, staff.name as name2 FROM allocatedresources a JOIN account worker ON a.workerID = worker.userid JOIN account staff ON a.staffID = staff.userid  WHERE a.staffid = $staffid";  // Select particular worker
            ...
            <div class="row" id="item">
                <div class="col-md-3" id="val" ><?php echo $resource['name1']." : ".$resource['workerID']; ?></div>
                <div class="col-md-2" id="val" ><?php echo $resource['resourceID']; ?></div>
                <div class="col-md-2" id="val"><?php echo $resource['quantity']; ?></div>
                <div class="col-md-3" id="val" ><?php echo $resource['name2']." : ".$resource['staffID']; ?></div>
                <div class="col-md-2" id="val" ><?php echo $resource['AllocDate']; ?></div>
            </div>
